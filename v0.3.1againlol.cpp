...
int main(){
    ...
    int choice1 , choice2 , choice3, choice4, choice5, yn; //αυτες οι μεταβλητες χρησιμοποιουνται για τα μενου επιλογων
    do{
            ...
            if(choice2 == 3){
                    ...
                    if(choice5 == 1){
                       ...
                       // agency.make_reservation() (??????)
                        ...
                        agency.delete_reservations(reserv_to_cancel);
